...
from windows.insert_window import *
...
INSERT_WINDOWS_DICT = {"Ученики": InsertStudentWindow,
                       "Преподователи": InsertTeacherWindow,
                       "Курсы": InsertCourseWindow,
                       "Группы": InsertGroupWindow}
